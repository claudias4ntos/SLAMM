        ...
        <div class="container">
                ...
                <div class="col-4">
                    ...
                    <div>
                        ...
                        <form  action="pais?action=insertar" method="POST">
                            ...
                            <label> INGRESE EL NOMBRE  DEL PAIS </label>
            ...
            <div class="row"> 
                ...
                <div class="col-6">
                    ...
                    <tbody>
                        <c:forEach items="${listaPaises}" var="pbean">
                            <tr>
                                ...
                                <td><a href="pais?action=eliminar&id_pais=${pbean.id_pais}" class="btn btn-danger">Eliminar</a></td>
                            </tr>
                        </c:forEach>
